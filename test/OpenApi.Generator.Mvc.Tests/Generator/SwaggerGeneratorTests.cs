...
namespace OpenApi.Generator.Mvc.Tests
{
    public class SwaggerGeneratorTests
    {
        ...
        public void GetSwagger_ThrowsInformativeException_IfActionsHaveNoHttpBinding()
        {
            ...
            Assert.Equal(
                "Ambiguous HTTP method for action - OpenApi.Generator.Mvc.Tests.FakeController.AcceptsNothing (OpenApi.Generator.Mvc.Tests). " +
        ...
        public void GetSwagger_ThrowsInformativeException_IfActionsHaveConflictingHttpMethodAndPath()
        {
            ...
            Assert.Equal(
                ...
                "OpenApi.Generator.Mvc.Tests.FakeController.AcceptsNothing (OpenApi.Generator.Mvc.Tests)," +
                "OpenApi.Generator.Mvc.Tests.FakeController.AcceptsStringFromQuery (OpenApi.Generator.Mvc.Tests). " +
